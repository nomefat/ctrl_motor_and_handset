...
#define NRF_CSN_HIGH()      HAL_GPIO_WritePin(rf_cs_GPIO_Port, rf_cs_Pin,GPIO_PIN_SET)
#define NRF_CSN_LOW()       HAL_GPIO_WritePin(rf_cs_GPIO_Port, rf_cs_Pin,GPIO_PIN_RESET)		        //csn置低
#define NRF_CE_HIGH()	      HAL_GPIO_WritePin(rf_ce_GPIO_Port,rf_ce_Pin,GPIO_PIN_SET)
#define NRF_CE_LOW()	      HAL_GPIO_WritePin(rf_ce_GPIO_Port,rf_ce_Pin,GPIO_PIN_RESET)		      //CE置低
#define NRF_Read_IRQ()		  HAL_GPIO_ReadPin ( rf_irq_GPIO_Port, rf_irq_Pin)  //中断引脚


#define NRF2_CSN_HIGH()     
#define NRF2_CSN_LOW()      		        //csn置低
#define NRF2_CE_HIGH()	    
#define NRF2_CE_LOW()	      	      //CE置低
#define NRF2_Read_IRQ()		    //中断引脚
